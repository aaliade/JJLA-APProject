...
public class Receipt {
    ...
    public void insertReceipt(String receiptNum, String equipIDfk, String custIDfk, String payType, Date payDate, double payAmt) {
        String sql = "INSERT INTO grizzly’sentertainmentequipmentrental.receipt (receiptNum, equipID, custID, payType, payDate, payAmt) VALUES "
                + "('" + receiptNum + "', '" + equipID + "', '" + custID + "', '" + payType + "', '" + payDate + "', " + payAmt + ");";
